...
var file_prod_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x64, 0x49, 0x64, 0x22, 0x1f, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53,
	0x69, 0x7a, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x3e, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x64, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x07, 0x70,
	0x72, 0x6f, 0x64, 0x72, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70,
	0x62, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x07,
	0x70, 0x72, 0x6f, 0x64, 0x72, 0x65, 0x73, 0x22, 0x2d, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x64, 0x52,
	...
	0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x32, 0xa7, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4d, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f,
	0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x72, 0x6f, 0x64,
	...
	0x64, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x49, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64,
	0x53, 0x74, 0x6f, 0x63, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x0d, 0x2e, 0x70, 0x62, 0x2e, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x53, 0x69, 0x7a, 0x65, 0x1a, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x72,
	0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x10,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0a, 0x12, 0x08, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x72, 0x6f, 0x64,
...
var file_prod_proto_goTypes = []interface{}{
	(*ProdRequest)(nil),      // 0: pb.ProdRequest
	(*QuerySize)(nil),        // 1: pb.QuerySize
	(*ProdResponseList)(nil), // 2: pb.ProdResponseList
	(*ProdResponse)(nil),     // 3: pb.ProdResponse
}
var file_prod_proto_depIdxs = []int32{
	3, // 0: pb.ProdResponseList.prodres:type_name -> pb.ProdResponse
	0, // 1: pb.ProdService.GetProdStock:input_type -> pb.ProdRequest
	1, // 2: pb.ProdService.GetProdStockSize:input_type -> pb.QuerySize
	3, // 3: pb.ProdService.GetProdStock:output_type -> pb.ProdResponse
	2, // 4: pb.ProdService.GetProdStockSize:output_type -> pb.ProdResponseList
...
type ProdServiceClient interface {
	...
	GetProdStockSize(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdResponseList, error)
}
...
func (c *prodServiceClient) GetProdStockSize(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdResponseList, error) {
	out := new(ProdResponseList)
	err := c.cc.Invoke(ctx, "/pb.ProdService/GetProdStockSize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProdServiceServer interface {
	...
	GetProdStockSize(context.Context, *QuerySize) (*ProdResponseList, error)
}
...
func (*UnimplementedProdServiceServer) GetProdStockSize(context.Context, *QuerySize) (*ProdResponseList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProdStockSize not implemented")
}
...
func _ProdService_GetProdStockSize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QuerySize)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProdServiceServer).GetProdStockSize(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ProdService/GetProdStockSize",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProdServiceServer).GetProdStockSize(ctx, req.(*QuerySize))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ProdService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetProdStockSize",
			Handler:    _ProdService_GetProdStockSize_Handler,
		},
	},
